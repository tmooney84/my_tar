...
SRC = main.c utils.c print_error.c my_printf.c file_header_fns.c hashmap.c #my_ls.c utils.c string_quicksort.c time_quicksort.c

# Object files (derived automatically from SRC)
OBJ = $(SRC:.c=.o)

# Header files (optional but useful for dependency management)
HEADERS = utils.h print_error.h my_printf.h file_header_fns.h  hashmap.h #utils.h string_quicksort.h time_quicksort.h
